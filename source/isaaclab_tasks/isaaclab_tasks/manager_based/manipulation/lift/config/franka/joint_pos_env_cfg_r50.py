...
MY_ROBOT_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"/home/roborock/IsaacLab/source/isaaclab_tasks/isaaclab_tasks/manager_based/manipulation/lift/robot_model/arm_description/urdf/R50/R50.usd",
...
class CoarseArmCubeLiftEnvCfg(LiftEnvCfg):
    def __post_init__(self):
        ...
        self.actions.arm_action = mdp.JointPositionActionCfg(
            ...
            asset_name = "robot", joint_names = ["M[0-5]"], scale = 0.3, use_default_offset = True
        )
        ...
        self.commands.object_pose.body_name = "M6_2_rightfinger_link"
